...
\begin{table}[h!]
\centering
\caption{Chi-square values for our fits. The fits were not very good, but improved when the end regions were excluded.  The fresnel double slit, in particular, did not fit well at all - a glance at the graph shows why. }
\begin{ruledtabular}
\begin{tabular}{cccc}
